...
export default function Invite({ domReady }) {
  return (
    <div className="mx-auto overflow-hidden relative">
      ...
      ></div>
      <div className="h-full min-h-screen w-[60%] mx-auto invite__row flex flex-col lg:relative">
        ...
        <div className="invite__column flex-grow-0 flex-shrink basis-auto -my-4">
          <div className="invite__item">
            <div className="invite__item__row flex justify-center">
        ...
        <div className="invite__column flex-grow-0 flex-shrink basis-auto -my-2">
          <Timer />
        </div>
